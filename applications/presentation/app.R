...
ui<-fluidPage(
  ...
  sidebarLayout(
    ...
    mainPanel(
      ...
      p("Welcome to MappingRebellions.com, a website that offers a unique 
      and comprehensive overview of hundreds of rebellions that took place in the Iberian world during the early modern period (1500 to 1850)."),
      ...
      p("What kind of events are we dealing with? – We use the term", em("rebellion"), "as a generic descriptor for all outbreaks of resistance that are commonly known by a variety of labels, the most common being uprising, riot, revolt, rebellion, mutiny, insurrection, and conspiracy (plus their corresponding words in Portuguese and in Spanish). To be more precise, only active, violent and collective actions of insurgency, carried out by subordinate people, with a minimum of 20 participants are considered for the purposes of this project."),
      p("As for the concept of", em("subordinate"), "we use it in context, meaning that it refers to all categories of people who, in each context, were considered or considered themselves to be subordinate whether from a social, ethnic or political viewpoint."),
